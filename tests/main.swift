...
// Session is a fuel gauge: 0 fine, 1 low, 2 nearly spent. Bands on the displayed integer.
check(sessionLevel(0) == 0 && sessionLevel(74) == 0, "under 75 -> 0")
check(sessionLevel(75) == 1 && sessionLevel(89) == 1, "75-89 -> 1")
check(sessionLevel(90) == 2 && sessionLevel(100) == 2, "90+ -> 2")
check(sessionLevel(74.6) == 1 && sessionLevel(74.4) == 0, "rounds like the displayed number")
check(sessionLevel(89.6) == 2, "rounds up into the top band")
